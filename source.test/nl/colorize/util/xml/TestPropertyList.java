...
import nl.colorize.util.xml.PropertyList;
...
public class TestPropertyList {
	...
	public void testSimpleProperties() {
		...
		assertEquals(1.23f, plist.getProperty("c", null));
	...
	public void testSaveAndLoadDate() {
		Date date = TestDataHelper.asDate("2011-01-20 00:00:00");
		PropertyList plist = new PropertyList();
	...
	public void testRealExample() throws Exception {
		...
		plist.save(tempFile);
		assertEquals(xml, Files.toString(tempFile, Charsets.UTF_8));
	}
	...
	public void testSaveAsProperties() throws IOException {
		...
		plist.setProperty("d", TestDataHelper.asDate(2013, 02, 21));
