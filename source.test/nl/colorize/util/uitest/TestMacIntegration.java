...
public class TestMacIntegration implements ApplicationMenuListener {
	...
	public JFrame createWindow() {
		...
		contentPanel.add(createButton("Toggle fullscreen", "toggleFullscreen"));
		contentPanel.add(createButton("Show notification", "showNotification"));
		contentPanel.add(createButton("Open browser", "openURL"));
		contentPanel.add(createButton("Open file", "openFile"));
	...
	private JButton createButton(String label, String actionMethod) {
		JButton button = new JButton(label);
		button.addActionListener(new ActionDelegate(this, actionMethod));
	...
	@Action
	public void setDockBadge() {
		MacIntegration.setDockBadge("1");
	}
	
	@Action
	public void bounceDockIcon() {
		try { 
			Thread.sleep(3000); 
