 ...
 */
public class TestInterpolation extends JPanel implements Animatable {
	...
	public static void main(String[] args) {
		...
		TestInterpolation test = new TestInterpolation();
		test.createWindow();
	}
	...
	public TestInterpolation() {
		...
		SwingAnimator animator = new SwingAnimator(20);
		animator.play(this);
		animator.start();
	}
	...
	public JFrame createWindow() {
		...
		selector.addActionListener(new ActionDelegate(this, "selectionChanged"));
		...
		playButton.addActionListener(new ActionDelegate(this, "playExample"));
