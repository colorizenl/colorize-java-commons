...
public class TestTuple {
	...
	public void testUnorderedTuple() {
		UnorderedTuple<String> unordered = UnorderedTuple.ofUnordered("A", "B");
		Tuple<String, String> ordered = Tuple.of("A", "B");
		
		assertTrue(unordered.equals(UnorderedTuple.ofUnordered("A", "B")));
		assertTrue(unordered.equals(UnorderedTuple.ofUnordered("B", "A")));
		assertFalse(unordered.equals(UnorderedTuple.ofUnordered("A", "A")));
		assertFalse(unordered.equals(ordered));
		assertFalse(unordered.equals(ordered.inverse()));
		assertEquals(1, ImmutableSet.of(unordered, unordered).size());
	}
