 ...
 */
public class ContentAssistField extends JTextField implements DocumentListener, FocusListener {
	...
	public ContentAssistField() {
		...
		addActionListener(new ActionDelegate(this, "hidePopup"));
	...
	public void changeSelection(Object selection) {
		setSelection((JMenuItem) selection);
		hidePopup();
	}
	...
	public void setContentAssistSuggestions(List<?> suggestions) {
		...
		for (String suggestion : stringForms) {
			...
			item.addActionListener(new ActionDelegate(this, "changeSelection"));
